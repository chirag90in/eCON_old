...
df <- read.table('MAX_neutral_estimated_responses.txt',header = TRUE,sep = ",")
...
cat(stan_code,file = "03-MAX-early-brms-stancode.stan",sep='\n')
...
save.image(file="03-MAX-early.RData")
